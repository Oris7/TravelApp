...
namespace TravelRecommendations.Auth
{
    public static class AuthEndpoints
    {
        ...
        {
            //register
            app.MapPost("api/accounts", async (UserManager<User> userManager, RegisteredUserDto dto) =>
            {
                //check user exists
        ...
        public record RegisteredUserDto(string UserName, string Email, string Password);
